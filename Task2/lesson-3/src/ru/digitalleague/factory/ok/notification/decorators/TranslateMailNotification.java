...
public class TranslateMailNotification implements Notification {
    ...
    private void localUser(String number) {
        ...
        switch (codeCountry) {
            case "7":
                address = LanguageNotification.RUSSIAN.getAddress();
                ...
                break;
            case "8":
                address = LanguageNotification.CHINESE.getAddress();
                ...
                break;
            case "9":
                address = LanguageNotification.UAE.getAddress();
                ...
                break;
            case "4":
                address = LanguageNotification.GERMAN.getAddress();
            ...
            case "3":
                ...
                switch (codeCountry) {
                    case "34":
                        address = LanguageNotification.SPAIN.getAddress();
                        ...
                        break;
                    case "33":
                        address = LanguageNotification.FRENCH.getAddress();
                        ...
                        break;
                    case "35":
                        address = LanguageNotification.PORTUGAL.getAddress();
                        ...
                        break;
                    default:
                        address = LanguageNotification.ENGLISH.getAddress();
