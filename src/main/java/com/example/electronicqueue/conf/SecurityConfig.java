...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/api/v1/users/**", "api/v1/reservations/users/**").hasAnyAuthority("ROLE_USER", "ROLE_ADMIN")
                ...
                .antMatchers("/api/v1/registration/**", "/api/v1/login/**", "/api/v1/activate/**").permitAll()
